from structneur import compartment_neur
import pickle
...
def Compartment(stimdir):
    ...
    for f in range(len(fulldata)):
        ...
        if fulldata[f] == None:
            ...
            if fulldata[f].cellID in L1list or fulldata[f].cellID in Tm3list:

                neurdic[fulldata[f].cellID] = compartment_neur.cell(fulldata[f])
                area[fulldata[f].cellID] = neurdic[fulldata[f].cellID].totalarea

                count += len(neurdic[fulldata[f].cellID].dendlist)
    ...
    from structneur import compartment_syn
        ...
        for p in neurdic[key].partners:
            ...
            if pID in neurdic.keys():
                ...
                """if key in connections['L1_L1'][0] and pID in connections['L1_L1'][1]:
                    info = compartment_syn.synapse(sender,receiver,synloc,tau=50)

                    synlist.append(info)"""

                if key in connections['L1_Mi1'][0] and pID in connections['L1_Mi1'][1]:
                    info = compartment_syn.synapse(sender,receiver,synloc)
                ...
                """if key in connections['Mi4_Mi4'][0] and pID in connections['Mi4_Mi4'][1]:
                    info = compartment_syn.synapse(sender,receiver,synloc,e=-80)
    ...
    for val in neurdic.values():
        ...
        heat_vec.record(val.dendlist[0](0.5)._ref_v)
        ...
        if val.cellID in Mi1list:
            ...
            Mi1soma_v_vec.record(val.dendlist[0](0.5)._ref_v)
        ...
        if val.cellID in L1list:
            ...
            L1soma_v_vec.record(val.dendlist[0](0.5)._ref_v)
        ...
        if val.cellID in Tm3list:
            ...
            Tm3soma_v_vec.record(val.dendlist[0](0.5)._ref_v)
        ...
        if val.cellID in Mi4list:
            ...
            Mi4soma_v_vec.record(val.dendlist[0](0.5)._ref_v)
        ...
        if val.cellID in Mi4list:
            ...
            Mi9soma_v_vec.record(val.dendlist[0](0.5)._ref_v)
        ...
        if val.cellID in T4list:
            ...
            T4soma_v_vec.record(val.dendlist[0](0.5)._ref_v)
        ...
        if val.cellID in T4alist:
            ...
            T4asoma_v_vec.record(val.dendlist[0](0.5)._ref_v)
        ...
        if val.cellID in T4blist:
            ...
            T4bsoma_v_vec.record(val.dendlist[0](0.5)._ref_v)
        ...
        if val.cellID in T4clist:
            ...
            T4csoma_v_vec.record(val.dendlist[0](0.5)._ref_v)
        ...
        if val.cellID in T4dlist:
            ...
            T4dsoma_v_vec.record(val.dendlist[0](0.5)._ref_v)
    ...
    datafolder = datadict['dataloc'] + 'compartment/' + str(stimdir)
